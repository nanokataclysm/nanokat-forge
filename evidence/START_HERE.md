...
Rebuilt to Documents when packaging script runs:

`~/Documents/NANOKAT-Forge-BuildWeek-upload-YYYYMMDD.zip`

## Do not upload

Secrets, `.env*`, private PEMs, `02-media/video/_work/` (build intermediates only).
